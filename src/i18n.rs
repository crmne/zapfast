...
fn lookup(lang: Language, key: &str) -> Option<&'static str> {
    Some(match (lang, key) {
        ...
        (Language::Portugues, "poll.view_votes") => "Ver votos",
        (_, "poll.view_votes") => "View votes",
        (Language::Portugues, "poll.no_votes") => "Nenhum voto ainda.",
        (_, "poll.no_votes") => "No votes yet.",
        (Language::Portugues, "poll.votes_unavailable") => "Esta enquete não está mais disponível.",
        (_, "poll.votes_unavailable") => "This poll is no longer available.",
